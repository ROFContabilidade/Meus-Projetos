...
def main():
    ...
    for sc in ("extrato_dominio.py", "folha_extrato_mensal.py", "entradas_dominio.py", "impostos_dominio.py", "razao_dominio.py", "comprovantes_itau.py", "consulta_cnpj.py", "plano_contas.py"):
